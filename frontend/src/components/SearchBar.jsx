...
const SearchBar = () => {
  ...
  return showSearch && visible ?(
    <div className='border-t border-b bg-black text-white text-center '>
        <div className='inline-flex items-center justify-center border border-gray-300 px-5 py-2 my-5 mx-3 rounded-full w-3/4 sm:w-1/2 bg-black text-white'>
